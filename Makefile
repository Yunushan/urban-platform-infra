...
MIGRATION_DOTNET_SDK_TARGET_VERSION ?=
MIGRATION_DOTNET_ROLL_FORWARD ?= LatestMajor
...
MIGRATION_CLEANUP_NODE_IMAGE_SCOPE ?= $(if $(filter lab,$(MIGRATION_PROFILE)),scheduled,desired)
