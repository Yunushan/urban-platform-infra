...
ANSIBLE_COLLECTION_REQUIREMENTS="${ANSIBLE_COLLECTION_REQUIREMENTS:-ansible/requirements.yml}"
...
ansible-galaxy collection install -r "$ANSIBLE_COLLECTION_REQUIREMENTS"
