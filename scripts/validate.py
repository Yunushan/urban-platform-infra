...
for makefile_helm_token in [
    ...
    'HELMFILE_SYNC_ATTEMPT_TIMEOUT ?=',
    'HELMFILE_SYNC_ATTEMPT_TIMEOUT=$(HELMFILE_SYNC_ATTEMPT_TIMEOUT)',
    'SKIP_HELMFILE_SYNC ?= auto',
    'SKIP_HELMFILE_SYNC="$(SKIP_HELMFILE_SYNC)"',
    'INSTALL_VELERO',
    ...
    'STRIMZI_WATCH_NAMESPACES="$(STRIMZI_WATCH_NAMESPACES)"',
...
for migration_automation_token in [
    ...
    'filter_service_pairs_for_service_filter',
    'MIGRATION_SERVICE_FILTER selected',
    'serviceFilter',
    'MIGRATION_STATE_FILE',
    'MIGRATION_RESUME',
    ...
    'cleanup_stale_import_configmaps',
    'reconcile_import_namespace_pod_security',
    ...
    'rewrite_nginx_runtime_paths_for_unprivileged',
    'ensure_nginx_main_pid_path',
    'ensure_nginx_http_temp_paths',
    'nginx_unprivileged_startup_script',
    '/tmp/nginx.pid',
    'fsGroupChangePolicy',
    'runAsUser',
    'client_body_temp_path /tmp/nginx/client_body;',
    'KAFKA_ENDPOINT_RE',
    'MIGRATION_KAFKA_BOOTSTRAP_SERVERS',
    'normalize_kafka_endpoint_text',
    'database_endpoint_rewrites',
    ...
    'FRONTEND_PRIVATE_HTTP_URL_RE',
    'normalize_private_frontend_http_endpoints',
    'config-rewrite-fingerprint',
    'env-rewrite-fingerprint',
    'imported_kafka_environment_defaults',
...
for helmfile_sync_retry_token in [
    ...
    'Default operator CRDs already exist and no Helmfile-only optional stacks are enabled',
    'diagnose_helmfile_output',
    'run_helmfile_sync',
    'timeout "${sync_attempt_timeout}"',
    'Client\\.Timeout',
    'Helmfile detected a chart repository or network timeout during this attempt.',
